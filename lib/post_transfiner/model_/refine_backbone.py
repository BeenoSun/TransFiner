...
from post_transfiner.utils.misc import NestedTensor, is_main_process
...
class Backbone(BackboneBase):
    ...
    def __init__(self, name: str,
        ...
        if is_main_process():
            ...
            print("loading model_zoo resnet50 backbone:", curr_pth + "/post_transfiner/671mot17_crowdhuman_mot17.pth")
            backbone.load_state_dict(torch.load(curr_pth + "/post_transfiner/671mot17_crowdhuman_mot17.pth"))
        '''
...
def build_backbone(args):
    ...
    backbone = Backbone(args.backbone_refine, train_backbone, return_interm_layers, args.dilation)
