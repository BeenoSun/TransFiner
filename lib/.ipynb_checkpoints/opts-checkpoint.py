...
class opts(object):
    def __init__(self):
        ...
        self.parser.add_argument('--wh_denomin', type=float, default=2.5)
        ...
        self.parser.add_argument('--stack_num', type=int, default=2)
        ...
        self.parser.add_argument('--loss_second_beta', type=float, default=1.5)
        self.parser.add_argument('--hm_lift', type=float, default=0.002)
