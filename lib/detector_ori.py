...
from model.model import create_model, load_model, load_track_model
...
class Detector(object):
    def __init__(self, opt):
        ...
        #model_ori = torch.load('/home/beeno/pycharm/py_code/CenterTrack/exp/tracking/mot17_half/paper_original_custom_dataset_amp_gradaccu_bsz16/model_70.pth')
        #self.model.load_state_dict(model_ori['state_dict'], strict=False)
        self.model = load_track_model(self.model, opt.load_model, opt)
